...
exports.show = function (Model, options, callback) {
	...
	if(Model.metadata && typeof Model.metadata.response_json_depth !== 'undefined' && typeof options.response_json_depth === 'undefined') {
		options.response_json_depth = Model.metadata.response_json_depth;
	}

	return this.invoker('show', false, Model, options, callback);
};
