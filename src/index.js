...
exports.create = function (Arrow) {
	...
	return Connector.extend({
		...
		capabilities: [Capabilities.ConnectsToADataSource, Capabilities.ValidatesConfiguration,
		//Capabilities.ContainsModels,
		Capabilities.GeneratesModels, Capabilities.CanCreate, Capabilities.CanRetrieve, Capabilities.CanUpdate, Capabilities.CanDelete, Capabilities.AuthenticatesThroughConnector],
